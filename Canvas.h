...
struct AGameObject
{
	...
	{
		UObject* Function = UObject::StaticFindObject(nullptr, nullptr, L"ShooterGame.GameObject.GetHealth", false);
...
struct AAresEquippable : UObject
{
	...
	{
		UObject* Function = UObject::StaticFindObject(nullptr, nullptr, L"ShooterGame.AresEquippable.GetEquippableMesh", false);
		if (!Function)
		{
			return 0;
		}
...
struct AShooterCharacter : UObject
{
	...
	{
		UObject* Function = UObject::StaticFindObject(nullptr, nullptr, L"Engine.Actor.K2_SetActorRotation", false);
		if (!Function)
		{
			return { 0,0,0 };
		}
	...
	{
		UObject* Function = UObject::StaticFindObject(nullptr, nullptr, L"ShooterGame.ShooterCharacter.IsDeadAndSettled", false);
	...
	{
		UObject* Function = UObject::StaticFindObject(nullptr, nullptr, L"ShooterGame.ShooterCharacter.SetCrouchTimeOverride", false);
		if (!Function)
		{
			return;
		}
	...
	void Set3pMeshVisible(bool value) {
		...
		if (!function)
			function = this->StaticFindObject(0, 0, L"ShooterCharacter.Set3PMeshVisible", false);
	...
	{
		UObject* Function = UObject::StaticFindObject(nullptr, nullptr, L"Engine.Actor.WasRecentlyRendered", false);
		if (!Function) { return 0; }
		struct
		{
			float Tolerance;
	...
	struct USkeletalMeshComponent* GetPawnMesh2()
	{
		UObject* Function = UObject::StaticFindObject(nullptr, nullptr, L"ShooterGame.ShooterCharacter.GetPawnMesh", false);
...
struct APlayerController : UObject
{
	...
	{
		UObject* function = UObject::StaticFindObject(nullptr, nullptr, L"ShooterGame.AresPlayerController.ClientForceSetControlRotation", false);
	...
	APawn* K2_GetPawn()
	{
		UObject* function = UObject::StaticFindObject(nullptr, nullptr, L"Engine.Controller.K2_GetPawn", false);
		if (!function)
		{
			return nullptr;
		}
...
namespace CWINGui
{
	...
	namespace Colors
	{
		...
		FLinearColor Window_Background{ 0.007f, 0.007f, 0.007f, 1.0f };
		FLinearColor Window_Header{ 0, 0.0f, 0.0f, 1.0f };

		FLinearColor Button_Idle{ 0.05f, 0.05f, 0.05f, 1.0f };
		FLinearColor Button_Hovered{ 0.08f, 0.08f, 0.08f, 1.0f };
		FLinearColor Button_Active{ 0.022f, 0.022f, 0.022f, 1.0f };

		FLinearColor Checkbox_Idle{ 0.05f, 0.05f, 0.05f, 1.0f };
		FLinearColor Checkbox_Hovered{ 0.08f, 0.08f, 0.08f, 1.0f };
		FLinearColor Checkbox_Enabled{ 255.0f, 0.0f, 0.0f, 1.0f };

		FLinearColor Combobox_Idle{ 0.05f, 0.05f, 0.05f, 1.0f };
		FLinearColor Combobox_Hovered{ 0.08f, 0.08f, 0.08f, 1.0f };
		FLinearColor Combobox_Elements{ 0.022f, 0.022f, 0.022f, 1.0f };

		FLinearColor Slider_Idle{ 0.05f, 0.05f, 0.05f, 1.0f };
		FLinearColor Slider_Hovered{ 0.05f, 0.05f, 0.05f, 1.0f };
		FLinearColor Slider_Progress{ 255.0f, 0.0f, 0.0f, 1.0f };
		FLinearColor Slider_Button{ 100.0f, 0.0f,  0.0f, 1.0f };

		FLinearColor ColorPicker_Background{ 0.0057f, 0.0057f, 0.0057f, 1.0f };
	}
	...
	void Draw_Cursor(bool toogle)
	{
		if (toogle)
		{
			...
			canvas->K2_DrawLine(FVector2D{ cursorPos.X, cursorPos.Y }, FVector2D{ cursorPos.X + 35, cursorPos.Y + 10 }, 1, FLinearColor{ 255.0f, 0.f, 0.f, 1.0f });
			...
			while (y != 30) //20 steps
			{
				...
				canvas->K2_DrawLine(FVector2D{ cursorPos.X, cursorPos.Y }, FVector2D{ cursorPos.X + x, cursorPos.Y + y }, 1, FLinearColor{ 255.0f, 0.f, 0.f, 1.0f });
			}

			canvas->K2_DrawLine(FVector2D{ cursorPos.X, cursorPos.Y }, FVector2D{ cursorPos.X + 15, cursorPos.Y + 30 }, 1, FLinearColor{ 255.0f, 0.f, 0.f, 1.0f });
			canvas->K2_DrawLine(FVector2D{ cursorPos.X + 35, cursorPos.Y + 10 }, FVector2D{ cursorPos.X + 15, cursorPos.Y + 30 }, 1, FLinearColor{ 255.0f, 0.f, 0.f, 1.0f });
		}
	}
	...
	bool Button(const wchar_t* name, FVector2D size)
	{
		...
		FVector2D padding = FVector2D{ 15, 8 };
		FVector2D pos = FVector2D{ menu_pos.X + padding.X + offset_x, menu_pos.Y + padding.Y + offset_y };
		if (sameLine)
		{
			pos.X = last_element_pos.X + last_element_size.X + padding.X;
	...
	void SliderInt(const wchar_t* name, int* value, int min, int max)
	{
		...
		FVector2D size = FVector2D{ 185, 15 };
		FVector2D slider_size = FVector2D{ 200, 5 };
		FVector2D padding = FVector2D{ 9, 4 };
		FVector2D pos = FVector2D{ menu_pos.X + padding.X + offset_x, menu_pos.Y + padding.Y + offset_y };
		if (sameLine)
		{
			pos.X = last_element_pos.X + last_element_size.X + padding.X;
	...
	void SliderFloat(const wchar_t* name, float* value, float min, float max, const char* format = "%.0f")
	{
		...
		FVector2D slider_size = FVector2D{ 180, 7 };
	...
	void Hotkey(const char* name, FVector2D size, int* key)
	{
		...
		FVector2D padding = FVector2D{ 15,5 };
		FVector2D pos = FVector2D{ menu_pos.X + padding.X + offset_x, menu_pos.Y + padding.Y + offset_y };
		if (sameLine)
		{
			pos.X = last_element_pos.X + last_element_size.X + padding.X;
	...
	void ColorPicker(const wchar_t* name, FLinearColor* color)
	{
		...
		float size = 25;
		float xsize = 5;
		FVector2D padding = FVector2D{ 13, 10 };
		FVector2D pos = FVector2D{ menu_pos.X + padding.X + offset_x, menu_pos.Y + padding.Y + offset_y };
		if (sameLine)
		{
			pos.X = last_element_pos.X + last_element_size.X + padding.X;
